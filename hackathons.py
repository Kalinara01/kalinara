    ...
    def create(self):
        ...
        try:
            cars = {
                ...
                'kuzov':int(input('Варианты кузова 1-седан, 2-универсал, 3-купе, 4-хэтчбэк, 5-минивен, 6-внедорожник, 7-пикап: ')),
...
class Cars(CreateMixin,ListingMixin,RetrieveMixin,UpdateMixin,DeleteMixin):
    def init(self,marka='',model='',year=0,kuzov='',volume=0,color='',probeg=0,price=0):
        self.marka = marka
        self.model = model
        self.year = year
        self.kuzov = kuzov
